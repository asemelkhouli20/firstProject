                ...
                <div class="card-body">
                    <form action="{{ route('posts.update', ['post' => $post->id]) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" id="content" name="content" rows="3" required>{{ old('content', $post->content) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('user_id') ? 'is-invalid' : '' }}" id="user_id" name="user_id" required>
